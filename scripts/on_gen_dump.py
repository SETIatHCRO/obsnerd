...
ap.add_argument('--ants', help="Ants to use", default='all')
args = ap.parse_args()


obs_look.gen_dump_script(date_path=args.date, base_path=args.base_dir, script_filename=args.script, ants=args.ants)