...
if __name__ == '__main__':
    ap.add_argument('source', help="Name of data file (.npz or .uvh5) for single band or <obsid> for obs (then lo/cnode).")
    ...
    if source_type in ['uvh5', 'npz']:  # Single file as source
        ...
        wide = starlink_obs.Obs(obsid=args.source, lo=args.lo, cnode=args.cnode)
